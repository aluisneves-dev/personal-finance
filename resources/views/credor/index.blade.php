...
<div class="row my-3">
  ...
  <div class="col-auto">
    <select name="orderBy" id="orderBy" class="form-select">
      ...
      <option value="nome">Credor</option>
    </select>
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
    <select name="regPag" id="regPag" class="form-select">
      <option value="30" selected>30 registros</option>
  ...
  <div class="col-auto">
    <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#modal_credor">
